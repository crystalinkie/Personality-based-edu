  ...
  return (
    <div style={{ background: "#1A1A2E", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", textAlign: "center" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 6, justifyContent: "center", marginBottom: 20 }}>
        {["VARK", "다중지능", "Krashen", "Deci & Ryan", "Vygotsky ZPD"].map((tag, i) => (
          <span key={i} style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 20, padding: "3px 10px", fontWeight: 500, letterSpacing: 0.3 }}>{tag}</span>
        ))}
      </div>
